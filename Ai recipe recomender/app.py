...
# Ensure both are 2D arrays before stacking
X_ingredients_dense = X_ingredients.toarray()  # Convert sparse matrix to dense array
X_combined = np.hstack([X_numerical, X_ingredients_dense])  # Horizontally stack
